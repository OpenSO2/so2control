...
int initLog()
{
	...
	sprintf(nameLogFile, "logs/log_%04d_%02d_%02d_%02d_%02d.txt",
		logStartTime.tm_year + 1900, logStartTime.tm_mon,
		logStartTime.tm_mday, logStartTime.tm_hour,
		logStartTime.tm_min);
	...
	fprintf(logfile, "Today is the %02d.%02d.%04d %02d:%02d\n",
		logStartTime.tm_mday, logStartTime.tm_mon,
		logStartTime.tm_year + 1900, logStartTime.tm_hour,
		logStartTime.tm_min);
	fprintf(logfile, "=======================================\n");
	fprintf(logfile, "%02d:%02d:%02d | INFO  | Program started \n",
		logStartTime.tm_hour, logStartTime.tm_min, logStartTime.tm_sec);
	fclose(logfile);
	return 0;
}
